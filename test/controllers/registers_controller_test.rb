...
class RegistersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post registers_url, params: { register: { name: @register.name, price: @register.price } }
    end
  ...
  test "should update register" do
    patch register_url(@register), params: { register: { name: @register.name, price: @register.price } }
